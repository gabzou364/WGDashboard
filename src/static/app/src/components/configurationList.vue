...
import DashboardOverview from "@/components/configurationListComponents/dashboardOverview.vue";
import {GetLocale} from "@/utilities/locale.js";

export default {
	name: "configurationList",
	components: {SystemStatus, LocaleText, ConfigurationCard, DashboardOverview},
	async setup(){
